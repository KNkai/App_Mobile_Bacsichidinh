...
import '../app_expanded_pageview.dart';

class ExpandablePageViewNew extends StatefulWidget {
  ...
  ///
  /// By default (false) [ExpandablePageViewNew] will resize to the size of it's
  ...
  /// [ExpandablePageViewNew] size animation. This can lead to a behaviour
  /// when after changing the page, [ExpandablePageViewNew] will first shrink to 0.0
  /// and then animate to the size of the page.
  ///
  /// For example: If there is certainty that most pages displayed by [ExpandablePageViewNew]
  ...
  @override
  _ExpandablePageViewNewState createState() => _ExpandablePageViewNewState();
}

class _ExpandablePageViewNewState extends State<ExpandablePageViewNew> {
  ...
  @override
  void didUpdateWidget(covariant ExpandablePageViewNew oldWidget) {
  ...
  bool _shouldReinitializeHeights(ExpandablePageViewNew oldWidget) {
